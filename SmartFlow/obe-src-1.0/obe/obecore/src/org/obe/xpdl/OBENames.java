...
public interface OBENames {
    ...
    String OBE_URL = "http://obe.sourceforge.net/";
    /**
     * The OBE namespace URI.
     */
    String OBE_NS_URI = OBE_URL + "2005/OBE1.0";
    ...
    String OBE_TIMER = "obe.Timer";
    String OBE_META_DATA = "obe.MetaData";

    String SEQUENTIAL_KIND = "SEQUENTIAL";
    String PARALLEL_KIND = "PARALLEL";
    String UNDEFINED_KIND = "UNDEFINED";
    String NORMAL_KIND = "NORMAL";
    String WARNING_KIND = "WARNING";
    String OVERDUE_KIND = "OVERDUE";
}